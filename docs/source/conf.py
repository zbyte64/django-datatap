...
from datatap import get_version
...
htmlhelp_basename = 'DjangoDataTapdoc'
...
latex_documents = [
  ('index', 'DjangoDataTap.tex', u'Django DataTap Documentation', 'Jason Kraus',
   'manual'),
]
...
man_pages = [
    ('index', 'djangodatatap', u'Django DataTap Documentation',
     [u'Jason Kraus'], 1)
]
